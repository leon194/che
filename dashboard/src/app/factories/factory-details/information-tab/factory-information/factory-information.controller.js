 ...
 * @author Oleksii Orel
 */
class FactoryInformationController {
    /**
     * Default constructor that is using resource injection
     * @ngInject for Dependency injection
     */
    constructor($scope, cheAPI, cheNotification, $location, $log, $timeout, lodash, $filter, $q, confirmDialogService) {
        this.cheAPI = cheAPI;
...
exports.FactoryInformationController = FactoryInformationController;
