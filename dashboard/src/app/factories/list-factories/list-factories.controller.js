 ...
 * @author Oleksii Orel
 */
class ListFactoriesController {
    /**
     * Default constructor that is using resource injection
     * @ngInject for Dependency injection
     */
    constructor($q, $log, cheAPI, cheNotification, $rootScope, confirmDialogService) {
        this.$q = $q;
        this.$log = $log;
        this.cheAPI = cheAPI;
...
exports.ListFactoriesController = ListFactoriesController;
